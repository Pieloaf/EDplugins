...
module.exports = new Plugin({
  ...
  load: function () {
    ...
    var range = document.getElementsByClassName(
      "scroller-2TZvBN none-2Eo-qx scrollerBase-289Jih"
    );
    var button = document.createElement("img");
    button.id = "hideside";
    button.src =
      "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fopenclipart.org%2Fimage%2F800px%2Fsvg_to_png%2F221605%2Fmenu-icon.png";
    button.width = 40;
    button.style.marginLeft = "17px";
    button.style.paddingBottom = "6px";
    button.onclick = function () {
      element["0"].style.transition = "width 0.2s ease";
